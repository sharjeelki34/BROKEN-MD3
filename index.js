...
app.post('/pair', async (req, res) => {
    ...
    if (!sock || !sock.authState) return res.send('Bot initialization wait karein aur page refresh karein!');
        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    input { width: 80%; max-width: 300px; }
                    button { background: #25D366; color: white; cursor: pointer; font-weight: bold; }
                    .code { font-size: 28px; color: #25D366; font-weight: bold; margin-top: 20px; letter-spacing: 4px; }
                </style>
            </head>
            <body>
                <h2>🤖 ${BOT_NAME} Pairing Code</h2>
